...
<div class="row">
	...
	<form name="form1" action="CommuBbsController">		
			...
			&nbsp;		
			<button type="button" class="btn btn-success" id="btnCatg1" value="1">애견Tip</button>
			&nbsp;
			<button type="button" class="btn btn-success" id="btnCatg2" value="2">중고장터</button>
			&nbsp;
			<button type="button" class="btn btn-success" id="btnCatg3" value="3">자유게시판</button>
	</div>
	</form>
	<div class="offset-md-1" ></div>
</div>
...
<div class="row">
 ...
 <hr>
 <div class="row">
 <div class="col-md-2" style="text-align: center; "><b>카테고리</b></div>
 <div class="col-md-1" style="text-align: center; "><b>번호</b></div>
 <div class="col-md-5" style="text-align: center; "><b>제목</b></div>
 <div class="col-md-2" style="text-align: center; "><b>작성자</b></div>
 <div class="col-md-1" style="text-align: center; "><b>작성일</b></div>
 <div class="col-md-1" style="text-align: center; "><b>조회수</b></div>
 </div>
 <hr>
 </div>
...
<% if(bbslist == null || bbslist.size() == 0){
	%>
 <div class="row" style="text-align: center; ">작성된 글이 없습니다. <hr></div>
