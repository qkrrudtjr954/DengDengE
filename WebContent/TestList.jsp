...
<hr>
<p>작성자 &nbsp;&nbsp;&nbsp; <%=comdto.getReg_date() %>&nbsp;&nbsp;&nbsp; 조회수 : <%=comdto.getReadcount() %>&nbsp;</p>
<hr>
<div class="row">
<div class="offset-md-1"></div>	
<div class="col-md-10">
...
<br>
<div class="row">
<button class="btn btn-success offset-md-5 col-md-1" type="button" id="btnUpdate">수정하기</button>
&nbsp;
<button type="button" id="btnDelete" class="btn btn-outline-secondary col-md-1">삭제하기</button>
</div>
</form>
